...
import com.sayitfast.usermgt.repository.EmployeeRepository;
...
/**
 * Created by IntelliJ IDEA. User: Rhett Herring 9/14/20 2:02 PM
 */
@Service
public class EmployServiceImpl implements EmployeeService {
  ...
  public Page<Employee> findPaginated(int pageNo, int pageSize, String sortField,
    ...
    // sort only
    // return (Page<Employee>) this.employeeRepository.findAll(sort);
